            ...
            <div className="chess-club-section">
              ...
              <div className="chess-photos-grid">
                ...
                <div className="chess-photo-card">
                  <img src="/static/images/bc.jpg" alt="Boston College Chess Tournament" />
                ...
                {/* E-Board Members */}
                <div className="chess-photo-card">
                  <img src="/static/images/eboard.png" alt="2025 E-Board Members" />
                  <div className="photo-content">
                ...
                {/* Founders */}
                <div className="chess-photo-card">
                  <img src="/static/images/founders.png" alt="Chess Club Founders" />
                  <div className="photo-content">
                ...
                <div className="chess-photo-card meeting-photo">
                  <img src="/static/images/meeting1.jpg" alt="Chess Club Weekly Meeting" />
                  <div className="photo-content">
                ...
                <div className="chess-photo-card meeting-photo">
                  <img src="/static/images/meeting2.jpg" alt="Chess Club Weekly Meeting" />
                  <div className="photo-content">
