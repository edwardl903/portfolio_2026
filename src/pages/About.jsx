        ...
        <div className="about-content">
          <div className="about-intro">
            ...
            <div className="about-photos">
              <div className="photo-card">
                <img src="/static/images/edward-portrait.jpg" alt="Edward Lai" className="main-photo" />
                <p className="photo-caption">Edward Lai</p>
              </div>
              <div className="photo-card">
                <img src="/static/images/charlie-dog.jpg" alt="Charlie the Dog" className="pet-photo" />
          ...
          <div className="adventure-cards">
            <div className="adventure-card">
              <img src="/static/images/family-photo.jpg" alt="The Lai Family" />
            ...
            <div className="adventure-card">
              <img src="/static/images/graduation-friends.jpg" alt="Graduation with Friends" />
              <div className="adventure-content">
                <h4>Friends</h4>
          ...
          <div className="adventure-cards">
            <div className="adventure-card">
              <img src="/static/images/mount-washington.jpg" alt="Mount Washington Climb" />
              <div className="adventure-content">
            ...
            <div className="adventure-card">
              <img src="/static/images/killington-snowboarding.jpg" alt="Snowboarding at Killington" />
              <div className="adventure-content">
            ...
            <div className="adventure-card">
              <img src="/static/images/sunday-river.JPG" alt="White Cap Peak, ME" />
              <div className="adventure-content">
